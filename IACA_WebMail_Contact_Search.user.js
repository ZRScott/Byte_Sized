...
// @updateURL    https://raw.githubusercontent.com/ZRScott/Byte_Sized/main/IACA_WebMail_Contact_Search.user.js
// @downloadURL  https://raw.githubusercontent.com/ZRScott/Byte_Sized/main/IACA_WebMail_Contact_Search.user.js
// ==/UserScript==
        ...
        initData() {
            ...
            if (selector) {
                for (let i = 0; i < selector.options.length; i++) {
                    ...
                    if (txt === "IACA - Teachers, Administration, and Staff") ccrDual.staffId = selector.options[i].value;
                    if (txt === "IACA - Enrolled Students") ccrDual.studentId = selector.options[i].value;
                    if (txt === "IACA - Enrolled Caretakers") ccrDual.caretakerId = selector.options[i].value;
                }
            }
